...
(
  ...
  fecha_creacion DATE NOT NULL CONSTRAINT DF_proyecto_fecha_creacion DEFAULT GETDATE(),   
  fecha_fin DATE,
...
(
  ...
  descripcion VARCHAR(200),
  fecha_creacion DATE NOT NULL CONSTRAINT DF_tarea_fecha_creacion DEFAULT GETDATE(), 
...
(
  ...
  fecha_comentario DATE NOT NULL CONSTRAINT DF_comentario_fecha_comentario DEFAULT GETDATE(),		
